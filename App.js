...
const NOTIFICATION_API_URL = 'https://zod-manpower.vercel.app/api/send-notification';
...
const translations = {
  en: {
    ...
    notificationMessage: 'Stay updated with new candidates and job opportunities!',
    allow: 'Allow',
  ...
  ar: {
    ...
    notificationMessage: 'ابق على اطلاع دائم بالمرشحين الجدد وفرص العمل!',
    allow: 'سماح',
...
const savePushToken = async (token, language) => {
  try {
    await fetch(`${API_URL.replace('/talents', '')}/save-token`, {
      method: 'POST',
